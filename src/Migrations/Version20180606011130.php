 ...
 */
class Version20180606011130 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE dados_pessoais (id INT AUTO_INCREMENT NOT NULL, foto VARCHAR(255) DEFAULT NULL, curriculo LONGTEXT DEFAULT NULL, cidade VARCHAR(100) DEFAULT NULL, estado VARCHAR(2) DEFAULT NULL, data_nascimento DATETIME DEFAULT NULL, cpf VARCHAR(11) DEFAULT NULL, telefone_ddd VARCHAR(2) NOT NULL, telefone_numero VARCHAR(9) DEFAULT NULL, logradouro VARCHAR(150) DEFAULT NULL, endereco_numero VARCHAR(10) DEFAULT NULL, bairro VARCHAR(100) DEFAULT NULL, cod_moip VARCHAR(30) DEFAULT NULL, data_cadastro DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', data_alteracao DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE servico CHANGE status status VARCHAR(1) NOT NULL COMMENT \'Usar P para publicado, A para Em Análise, I para Inativo, E para Excluído e R para Rejeitado\'');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE servico CHANGE status status VARCHAR(1) NOT NULL COLLATE utf8mb4_unicode_ci COMMENT \'Usar P para publicado, A para Em Analise, I para Inativo, E para excluido e R para Rejeitado\'');

 ...
 */
class Version20180505022112 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE categoria CHANGE slug slug VARCHAR(255) NOT NULL, CHANGE data_alteracao data_alteracao DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE categoria CHANGE slug slug VARCHAR(100) NOT NULL COLLATE utf8mb4_unicode_ci, CHANGE data_alteracao data_alteracao DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    }
}
